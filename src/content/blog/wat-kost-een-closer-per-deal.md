---
locale: "nl"
title: "Wat kost een closer per deal? Kostenoverzicht en rekenvoorbeeld"
description: "Wat kost het inzetten van een closer echt? Bekijk de commissiestructuur, een vergelijking met een vaste salesmedewerker en een concreet rekenvoorbeeld."
keyword: "wat kost een closer per deal"
secondaryKeywords:
  - "closer kosten"
  - "closer inhuren kosten"
  - "commissie closer"
  - "no cure no pay sales"
  - "kosten salesmedewerker versus closer"
pillar: "High ticket sales"
category: "Voor bedrijven"
publishedAt: 2026-07-07
author: "Stefan Kelderman"
image: "/images/process/step-4-resultaat.png"
imageAlt: "Overzicht van de kosten en opbrengsten bij het inzetten van een closer"
readingTime: "10 min"
faq:
  - question: "Werken closers altijd op commissiebasis?"
    answer: "Bij ClosersMatch en de meeste gespecialiseerde platforms is commissie (no cure no pay) het standaardmodel. Sommige closers combineren dit met een kleine vaste vergoeding of retainer, maar het overgrote deel van de vergoeding hangt af van daadwerkelijk gesloten deals."
  - question: "Wat is een gebruikelijk commissiepercentage voor een closer?"
    answer: "Dit varieert per branche en dealgrootte, maar percentages tussen de 5% en 20% van de dealwaarde komen het vaakst voor. Bij hogere dealwaarden ligt het percentage doorgaans lager, bij kleinere deals iets hoger, om de vergoeding voor de closer in verhouding te houden."
  - question: "Is een closer inhuren goedkoper dan een salesmedewerker aannemen?"
    answer: "In de meeste gevallen wel, zeker in de opstartfase. Je betaalt geen vast salaris, geen werkgeverslasten en geen kosten tijdens de inwerkperiode. Je betaalt pas zodra er daadwerkelijk omzet wordt gerealiseerd."
  - question: "Wat gebeurt er als de closer geen deals sluit?"
    answer: "Bij een zuiver commissiemodel kost dat je dan niets, afgezien van de tijd die is geïnvesteerd in de samenwerking. Dat is precies het voordeel van no cure no pay: het financiële risico ligt voor een groot deel bij de closer, niet bij jou als opdrachtgever."
  - question: "Is het goedkoper om te investeren in meer leads dan in een closer?"
    answer: "Niet per se. Meer leads genereren kost geld zonder garantie dat de conversie verbetert. Een closer die je conversieratio verhoogt, haalt vaak meer omzet uit dezelfde hoeveelheid leads, tegen een kostenpost die alleen ontstaat bij resultaat."
  - question: "Kan ik onderhandelen over het commissiepercentage?"
    answer: "Ja, commissiepercentages zijn vaak bespreekbaar en hangen af van factoren zoals dealgrootte, complexiteit van het verkoopproces en of de closer met warme of koude leads werkt. Bij ClosersMatch wordt dit per match afgestemd tussen bedrijf en closer."
  - question: "Zijn er nog andere kosten naast de commissie?"
    answer: "Meestal niet, afgezien van eventuele tools zoals een CRM-systeem dat je toch al nodig hebt voor je salesproces. Er zijn geen kosten voor werving, contractvorming voor vast personeel of langdurige verplichtingen."
relatedLinks:
  - label: "Lees hoe het no cure no pay model precies werkt"
    href: "/nl/no-cure-no-pay"
  - label: "Ontdek hoe ClosersMatch bedrijven koppelt aan closers"
    href: "/nl/voor-bedrijven"
  - label: "Bekijk voorbeelden van behaalde resultaten"
    href: "/nl/cases"
draft: false
---
...
Benieuwd wat een closer voor jouw specifieke situatie zou kunnen betekenen? Lees meer over [het no cure no pay model van ClosersMatch](/nl/no-cure-no-pay) en ontdek hoe de commissiestructuur wordt afgestemd op jouw dealwaarde en branche.
